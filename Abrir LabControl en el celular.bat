@echo off
title Insuco LabControl - Acceso desde el celular - v3.1
...
rem Iniciar el servidor de esta version (3.1)
powershell -NoProfile -Command "Write-Host 'Iniciando servidor de Insuco LabControl v3.1...' ; Start-Process node -ArgumentList 'server.js' -WorkingDirectory '%~dp0website\backend' -WindowStyle Hidden"
