@echo off
title Insuco LabControl - Acceso desde el celular - v2.2
...
rem Iniciar el servidor de esta version (2.2)
powershell -NoProfile -Command "Write-Host 'Iniciando servidor de Insuco LabControl v2.2...' ; Start-Process node -ArgumentList 'server.js' -WorkingDirectory '%~dp0website\backend' -WindowStyle Hidden"
