@echo off
title Insuco LabControl - Acceso desde el celular - v3.0
...
rem Iniciar el servidor de esta version (3.0)
powershell -NoProfile -Command "Write-Host 'Iniciando servidor de Insuco LabControl v3.0...' ; Start-Process node -ArgumentList 'server.js' -WorkingDirectory '%~dp0website\backend' -WindowStyle Hidden"
