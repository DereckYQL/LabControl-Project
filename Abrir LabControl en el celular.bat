@echo off
title Insuco LabControl - Acceso desde el celular - v2.8
...
rem Iniciar el servidor de esta version (2.8)
powershell -NoProfile -Command "Write-Host 'Iniciando servidor de Insuco LabControl v2.8...' ; Start-Process node -ArgumentList 'server.js' -WorkingDirectory '%~dp0website\backend' -WindowStyle Hidden"
timeout /t 3 /nobreak >nul

rem Mostrar la direccion y el codigo QR para escanear con el celular
chcp 65001 >nul
node "%~dp0website\config\celular.js"
