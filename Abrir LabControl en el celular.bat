@echo off
title Insuco LabControl - Acceso desde el celular - v2.9
...
rem Iniciar el servidor de esta version (2.9)
powershell -NoProfile -Command "Write-Host 'Iniciando servidor de Insuco LabControl v2.9...' ; Start-Process node -ArgumentList 'server.js' -WorkingDirectory '%~dp0website\backend' -WindowStyle Hidden"
